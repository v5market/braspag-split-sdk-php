# Sem split no cartão de crédito
...
$fraudAnalysis->setSequence(ConstantFraudAnalysis::SEQUENCE_ANALYSE);
...
$payment->addExtraDataCollection('NomeDoCampo', 'Valor do campo');
